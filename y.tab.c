...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_THROW = 8,                      /* THROW  */
  YYSYMBOL_TRY = 9,                        /* TRY  */
  YYSYMBOL_CATCH = 10,                     /* CATCH  */
  YYSYMBOL_FINALLY = 11,                   /* FINALLY  */
  YYSYMBOL_ISIT = 12,                      /* ISIT  */
  YYSYMBOL_MAYBE = 13,                     /* MAYBE  */
...
{
       0,    81,    81,    82,    86,    91,    99,   100,   101,   105,
     109,   113,   117,   121
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "DECLARE", "AS", "SET",
  "ASK", "RETURN", "THROW", "TRY", "CATCH", "FINALLY", "ISIT", "MAYBE",
  "OTHERWISE", "DURING", "COUNT", "FROM", "TO", "SAY", "DO", "TYPE_NUMBER",
  "TYPE_TEXT", "TYPE_LOGIC", "LOGIC_TRUE", "LOGIC_FALSE", "NUMBER",
  "STRING", "IDENTIFIER", "PLUS", "MINUS", "TIMES", "DIVIDE", "SAME",
  "DIFFERENT", "SMALLER", "BIGGER", "SMALLER_EQUAL", "BIGGER_EQUAL",
  "BOTH", "EITHER", "'!'", "'('", "')'", "'{'", "'}'", "','", "$accept",
  "program", "line", "type", "expression", YY_NULLPTR
};
...
{
      -3,   -19,     5,    11,    -3,     8,   -23,   -29,   -29,   -15,
     -29,   -29,   -29,   -29,   -29,   -28,   -29,   -29,   -29,   -27,
     -29,   -29
};
...
{
       1,    10,    11,    12,    13,    14,    16,    17,    18,     5,
       6,     7,     9,    20,    21,     0,     8,     0,     0,     0,
       0,     0,     0,     0,     0,     2
};

static const yytype_int8 yycheck[] =
{
       3,    24,    25,    26,    27,    28,    21,    22,    23,    28,
       5,     0,     4,    41,    41,    -1,     4,    -1,    -1,    -1,
      -1,    -1,    -1,    -1,    -1,    28
};
...
{
       0,     3,    28,    48,    49,    28,     5,     0,    48,     4,
      24,    25,    26,    27,    28,    51,    21,    22,    23,    50,
      41,    41
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: DECLARE IDENTIFIER AS type '!'  */
#line 87 "plainscript.y"
    {
    addVariable((yyvsp[-3].identifier), (yyvsp[-1].num));
        printf("Declared variable: %s as type %d\n", (yyvsp[-3].identifier), (yyvsp[-1].num));
    }
#line 1294 "y.tab.c"
    break;

  case 5: /* line: IDENTIFIER SET expression '!'  */
#line 92 "plainscript.y"
    {
        updateSymbolVal((yyvsp[-3].identifier), (yyvsp[-1].typedval).type, &(yyvsp[-1].typedval).value);
        printf("Assigned variable: %s\n", (yyvsp[-3].identifier));
    }
#line 1303 "y.tab.c"
    break;

  case 6: /* type: TYPE_NUMBER  */
#line 99 "plainscript.y"
                { (yyval.num) = 1; }
#line 1309 "y.tab.c"
    break;

  case 7: /* type: TYPE_TEXT  */
#line 100 "plainscript.y"
                { (yyval.num) = 2; }
#line 1315 "y.tab.c"
    break;

  case 8: /* type: TYPE_LOGIC  */
#line 101 "plainscript.y"
                 { (yyval.num) = 3; }
#line 1321 "y.tab.c"
    break;

  case 9: /* expression: NUMBER  */
#line 105 "plainscript.y"
             {
...
#line 1330 "y.tab.c"
  ...
  case 10: /* expression: STRING  */
#line 109 "plainscript.y"
             {
...
#line 1339 "y.tab.c"
  ...
  case 11: /* expression: LOGIC_TRUE  */
#line 113 "plainscript.y"
                 {
...
#line 1348 "y.tab.c"
  ...
  case 12: /* expression: LOGIC_FALSE  */
#line 117 "plainscript.y"
                  {
          (yyval.typedval) = (TypedValue){ .type = 3 };
